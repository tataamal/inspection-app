                ...
                @foreach ($data as $index => $row)
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150 border-b border-gray-100">
                        ...
                        <td class="p-3 text-center">
                            ...
                            @else
                                <a href="{{ route('inspection-semarang', $row->AUFNR) }}"><button class=" bg-green-500 hover:bg-green-600 text-white px-3 py-1.5 rounded-md font-medium text-xs transition-colors duration-150 shadow-sm">
                                    ACCEPT
                                </button></a>
                            @endif
                        </td>
