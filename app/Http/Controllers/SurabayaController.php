...
{
    public function InspectionLotSurabaya()
    {
        return $this->inspection_lot('2000', 'Surabaya.pro');
    }
    ...
    public function TaskDOSurabaya()
    {
        $data = DB::table('quality_inspection_lots')
            ->where('WERK', '2000')
            ->where('ART', '10')
    ...
    public function ActionButton($aufnr)
    {
        ...
        return view('surabaya.inspection', compact('data'));
    }
}
